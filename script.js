const questions = [
    ...
    },
    {
        ...
        sticker: "stickers/да_я_сучка.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/ебать_ты_сосочка.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/удостоверение_стервы.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/гусеница_курит.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/как_вы_все_заебали.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/котенок_шлха.webp",
        answers: [
    ...
    },
    {
        ...
        sticker: "stickers/шрек_снимает.webp",
        answers: [
...
const results = [
    {
        ...
        sticker: "stickers/ого_ну_и_хуйня.webp",
        details: [
    ...
    },
    {
        ...
        sticker: "stickers/котенок_матерится.webp",
        details: [
    ...
    },
    {
        ...
        sticker: "stickers/котенок_стреляет.webp",
        details: [
...
function selectAnswer(answer, question, button) {
    ...
    if (timeSinceLastClick < 300) {
        clickCount++;
        if (clickCount >= 3) {
            showEasterEgg("⚠️ Пожалуйста, не мешайте тесту\nОн и так знает результат", "stickers/котенок_матерится.webp");
            clickCount = 0;
            return;
        }
    } else {
...
function handleExplosion(button, question) {
    ...
    let sticker = "stickers/котенок_стреляет.webp";
...
function retryTest() {
    retryCount++;
    if (retryCount === 1) {
        showEasterEgg("Результат не изменился\n(что вы ожидали?)", "stickers/гусеница_курит.webp");
    } else if (retryCount === 2) {
        showEasterEgg("Результат всё ещё не изменился\n(вы упорный, это хорошо)", "stickers/плачет.webp");
    } else {
        retryCount = 0;
        startTest();
    }
...
function addArgument() {
    const args = [
        { text: "Аргумент добавлен в базу данных", sticker: "stickers/гусеница_курит.webp" },
        { text: "Ваш аргумент принят к сведению", sticker: "stickers/котенок_матерится.webp" },
        { text: "Аргумент обработан нейросетью", sticker: "stickers/ого_ну_и_хуйня.webp" },
        { text: "Аргумент отправлен на рассмотрение", sticker: "stickers/котенок_стреляет.webp" },
        { text: "Аргумент добавлен.\nРезультат не изменился 😉", sticker: "stickers/да_я_сучка.webp" }
    ];
